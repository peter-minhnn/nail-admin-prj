...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from '@/components/(admin)/ui/collapsible.tsx'
import {
  SidebarGroup,
  SidebarGroupLabel,
  SidebarMenu,
...
import { NavCollapsible, NavItem, NavLink, type NavGroup } from './types.ts'
    ...
    >
      <SidebarMenuItem>
        <CollapsibleTrigger asChild>
          <SidebarMenuButton
            tooltip={item.title ? intl.formatMessage({ id: item.title }) : ''}
          >
            {item.icon && <item.icon />}
            <span>
              <FormattedMessage id={item.title} />
