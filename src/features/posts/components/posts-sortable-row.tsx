...
export const PostsSortableRow = ({ row, isOver }: { row: Row<PostsDataType>, isOver: boolean }) => {
  ...
  return (
    ...
    >
      {/* Drag Handle */}
      <TableCell id={uuid()} className="p-2 w-14 cursor-move text-center" {...attributes} {...listeners}>
        ⋮⋮
      </TableCell>
