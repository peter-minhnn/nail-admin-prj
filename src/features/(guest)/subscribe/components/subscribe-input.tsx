      ...
      <div className='flex w-full flex-col'>
        <div className='relative flex w-full flex-1'>
          ...
          <input
            id='input-group-1'
            type='text'
            className={`h-[50px] w-full rounded-md border-2 border-gray-400 bg-transparent p-2.5 ps-10 text-sm outline-none focus:border-orange-500 ${(errorMessage ?? hasError) ? 'border-red-500' : ''}`}
            ref={ref}
            {...props}
          />
        </div>
