...
export default function ProductSectionHeader(props: Readonly<ProductSectionHeaderProps>) {
    ...
    const ControllButton = ({
        ...
        return (
            <div
                className={`mx-4 w-fit items-end gap-8 flex`}
            >
                <img
                    onClick={goPrev}
                    alt=''
    ...
    return ((props.leftSide ?? true) ? (
        <div className='h-fit w-screen flex-col px-4 md:px-20 lg:px-44'>
            ...
            <div className='flex flex-1 justify-end gap-3'>
                ...
                <div className="w-fit">
                    <ControllButton goNext={props.onNextClick} goPrev={props.onPreviousClick} />
                </div>
            </div>
        </div >
    ) : (
